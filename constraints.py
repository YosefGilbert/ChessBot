...
class Board:
    ...
    def findLegalPositions(self):
        ...
        # castling: should first check that none of the necessary pieces have moved.
        # kingside
        if position[0][4] == "k" and position[0][5] == "0" and position[0][6] == "0" and position[0][7] == "r":
            new_position = self.generatePosition(0, 4, 0, 6)
            new_position[0][7] = "0"
            new_position[0][5] = "r"
            positions.append(new_position)

        if position[7][4] == "K" and position[7][5] == "0" and position[7][6] == "0" and position[7][7] == "R":
            new_position = self.generatePosition(0, 4, 0, 6)
            new_position[7][7] = "0"
            new_position[7][5] = "R"
            positions.append(new_position)
        ...
        # queenside
        if position[0][4] == "k" and position[0][3] == "0" and position[0][2] == "0" and position[0][1] == "0" and position[0][0] == "r":
            new_position = self.generatePosition(0, 4, 0, 2)
            new_position[0][0] = "0"
            new_position[0][3] = "r"
            positions.append(new_position)

        if position[7][4] == "K" and position[7][5] == "0" and position[7][6] == "0" and position[0][2] == "0" and position[7][0] == "R":
            new_position = self.generatePosition(0, 4, 0, 6)
            new_position[7][7] = "0"
            new_position[7][5] = "R"
            positions.append(new_position)
